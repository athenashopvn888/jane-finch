...
const home = [readFileSync("app/page.tsx", "utf8"), readFileSync("app/HomePageClient.tsx", "utf8")].join("\n");

test("protected owner renders exactly one H1 and approved content", () => {
  assert.equal((landing.match(/<h1>/g) || []).length, 1);
  assert.match(discovery, /Jane Finch Cannabis — Weed Dispensary in North York/);
