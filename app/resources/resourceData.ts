...
const seeds: PageSeed[] = [
  ...
  },
  {
    ...
    childRoutes: [
      ...
      "/resources/vape-guides/nicotine-vape-jane-finch",
    ],
    commercialLinks: [
      menuLink("Browse THC vapes", "/items/vape-disposables", "Open the THC Vape category."),
      menuLink("North York nicotine vape page", "/nicotine-vape-north-york", "Open the live Jane Finch / North York nic-vape LP."),
  ...
  },
  {
    ...
    author: LOCAL,
    childRoutes: [
      "/resources/local-guides/weed-dispensary-in-jane-and-finch",
      "/resources/local-guides/24-hour-jane-finch-walk-in",
      "/resources/local-guides/north-york-cannabis-delivery",
    ],
    commercialLinks: [
      menuLink("Open the store page", STORE_ROUTE, "Review Jane Finch Cannabis visit information."),
      menuLink("24-hour Jane Finch FAQ", "/24-hour-dispensary-north-york", "Walk-in 24h / open-now hours at 2728 Jane St."),
      menuLink("North York cannabis delivery", "/cannabis-delivery-north-york", "Courier hours 10 a.m.–10 p.m., not 24h walk-in."),
    ],
  },
  {
  ...
  },
  {
    ...
    commercialLinks: [
      menuLink("Jane Finch Native cigarettes page", "/native-cigarettes-jane-finch", "Open the live Jane–Finch cigarette neighbourhood LP."),
  ...
  {
    route: "/resources/vape-guides/nicotine-vape-jane-finch",
    kind: "article",
    pageType: "Vape Guide",
    parentRoute: "/resources/vape-guides",
    h1: "Nicotine Vape at Jane Finch — Menu vs Neighbourhood Page",
    seoTitle: "Nicotine Vape Jane Finch Guide | Jane Finch Cannabis",
    metaDescription: "Use the North York nicotine vape neighbourhood page, then /items/vapes, at Jane Finch Cannabis. Adults 19+. Nicotine is addictive.",
    excerpt: "A short path from the Jane & Finch nic-vape LP to the live category.",
    body: "Jane Finch Cannabis keeps nicotine vapes in a dedicated category at 2728 Jane St, North York.\n\n## Start on the neighbourhood page\n\nOpen /nicotine-vape-north-york for Jane–Finch / North York intent, hours, and FAQ.\n\n## Then check the live menu\n\nCurrent names and formats stay on /items/vapes. THC vapes stay on /items/vape-disposables.\n\n## Adults 19+\n\nNicotine is addictive. Bring valid government photo ID. Listings can change.",
    commercialLinks: [
      menuLink("North York nicotine vape page", "/nicotine-vape-north-york", "Open the live nic-vape neighbourhood LP."),
      menuLink("Browse nicotine vapes", "/items/vapes", "Open the current Nicotine Vape category."),
    ],
  },
  {
    route: "/resources/local-guides/24-hour-jane-finch-walk-in",
    kind: "article",
    pageType: "Local Visit Guide",
    parentRoute: "/resources/local-guides",
    h1: "24-Hour Walk-In at Jane Finch",
    seoTitle: "24-Hour Jane Finch Walk-In Guide | Jane Finch Cannabis",
    metaDescription: "Jane Finch Cannabis walk-in at 2728 Jane St is open 24 hours. Use the live 24-hour FAQ. Delivery stays 10 a.m.–10 p.m.",
    excerpt: "Short walk-in hours note tied to the live North York 24-hour FAQ.",
    body: "The Jane Street counter at 2728 Jane St, North York is open 24 hours, 7 days.\n\n## Use the live 24-hour FAQ\n\nHours truth, open-now questions, and Jane–Finch arrival stay on /24-hour-dispensary-north-york.\n\n## Delivery is a different clock\n\nLIVE ORDER runs 10 a.m. to 10 p.m. only. A 24-hour search is walk-in, not a 24-hour courier.\n\n## Adults 19+\n\nBring valid government photo ID. No appointment.",
    author: LOCAL,
    commercialLinks: [
      menuLink("24-hour Jane Finch FAQ", "/24-hour-dispensary-north-york", "Open the live B09 24-hour / open-now FAQ."),
      menuLink("North York cannabis delivery", "/cannabis-delivery-north-york", "Courier hours 10 a.m.–10 p.m."),
    ],
  },
  {
    route: "/resources/local-guides/north-york-cannabis-delivery",
    kind: "article",
    pageType: "Local Visit Guide",
    parentRoute: "/resources/local-guides",
    h1: "North York Cannabis Delivery from Jane Finch",
    seoTitle: "North York Cannabis Delivery Guide | Jane Finch Cannabis",
    metaDescription: "Jane Finch Cannabis delivery runs 10 a.m.–10 p.m. from 2728 Jane St. Use the live North York delivery page. Not 24-hour delivery.",
    excerpt: "Short courier note tied to the live /cannabis-delivery-north-york page.",
    body: "Delivery from Jane Finch Cannabis is a separate courier window from the 24-hour walk-in counter.\n\n## Use the live delivery page\n\nHours, FAQ, and how-to-order stay on /cannabis-delivery-north-york.\n\n## Then open the delivery menu\n\nLIVE ORDER is on /delivery during 10 a.m.–10 p.m. only.\n\n## Walk-in stays 24 hours\n\nOvernight visits use /24-hour-dispensary-north-york, not the courier page.",
    author: LOCAL,
    commercialLinks: [
      menuLink("North York cannabis delivery", "/cannabis-delivery-north-york", "Open the live delivery neighbourhood LP."),
      menuLink("Delivery menu", "/delivery", "Start LIVE ORDER during courier hours."),
    ],
  },
  {
...
export const RESOURCE_ROUTE_LABELS: Record<string, string> = {
  ...
  "/native-cigarettes-jane-finch": "Jane Finch Native cigarettes",
  "/nicotine-vape-north-york": "North York nicotine vape",
  "/24-hour-dispensary-north-york": "24-hour Jane Finch FAQ",
  "/cannabis-delivery-north-york": "North York cannabis delivery",
