...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Is Jane Finch Cannabis the Right Weed Dispensary in North York for Your Visit?",
    "seoTitle": "Jane Finch Cannabis Weed Dispensary in North York | Visit Guide",
    "seo_title": "Jane Finch Cannabis Weed Dispensary in North York | Visit Guide",
    "metaDescription": "Plan a North York visit to Jane Finch Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a North York visit to Jane Finch Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
    "h1": "Is Jane Finch Cannabis the Right Weed Dispensary in North York for Your Visit?",
    "excerpt": "A practical North York visit guide for adults 19+ checking Jane Finch Cannabis.",
  ...
  },
  {
    ...
    "title": "Jane Finch Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "Jane Finch Cannabis Flower Guide | North York Budget to Exotic",
    "seo_title": "Jane Finch Cannabis Flower Guide | North York Budget to Exotic",
    "metaDescription": "Compare Jane Finch Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare Jane Finch Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "Jane Finch Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for Jane Finch Cannabis, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "authorName": "Nia Jane",
    "authorHandle": "@NiaFinchGuide",
    "authorRole": "House Writer",
    "author": "Nia Jane",
  ...
  },
  {
    ...
    "title": "Jane Finch Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "Jane Finch Cannabis Menu Guide | North York Weed Store Categories",
    "seo_title": "Jane Finch Cannabis Menu Guide | North York Weed Store Categories",
    "metaDescription": "Use this Jane Finch Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this Jane Finch Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "Jane Finch Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical North York menu guide for Jane Finch Cannabis, with natural category paths for adults 19+.",
    "authorName": "Jay Finch",
    "authorHandle": "@JayAtJaneFinch",
    "authorRole": "House Writer",
    "author": "Jay Finch",
