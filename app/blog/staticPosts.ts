...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Jane Finch Cannabis Visit Without Guessing",
    "seoTitle": "Jane Finch Cannabis Visit Guide | Weed Dispensary in North York",
    "seo_title": "Jane Finch Cannabis Visit Guide | Weed Dispensary in North York",
    "metaDescription": "Plan a Jane and Finch visit to Jane Finch Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Jane and Finch visit to Jane Finch Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Jane Finch Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Jane Finch Cannabis, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "seoTitle": "Jane Finch Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Jane Finch Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Jane Finch Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Jane Finch Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Jane Finch Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Jane Finch Cannabis.",
    "authorName": "Nia Jane",
    "authorHandle": "@NiaFinchGuide",
    "authorRole": "House Writer",
    "author": "Nia Jane",
  ...
  },
  {
    ...
    "seoTitle": "Jane Finch Cannabis Menu Guide | North York Weed Store",
    "seo_title": "Jane Finch Cannabis Menu Guide | North York Weed Store",
    "metaDescription": "Shop the Jane Finch Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Jane Finch Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Jane Finch Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Jane Finch Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Jay Finch",
    "authorHandle": "@JayAtJaneFinch",
    "authorRole": "House Writer",
    "author": "Jay Finch",
