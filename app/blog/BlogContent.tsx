...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Jane Finch Cannabis is North York's Best Dispensary",
  ...
  },
  {
    ...
    title: "North York Cannabis Laws in 2026 — What You Need to Know",
    excerpt: "Age limits, public consumption rules, possession limits, and where you can legally smoke in North York. Stay informed.",
    date: "2026-04-25",
    category: "News",
    emoji: "⚖️",
    readTime: "4 min",
...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the North York area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=JFC01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <p className={styles.heroSub}>
            Cannabis guides, strain reviews, and dispensary news from North York&apos;s
            premium dispensary.
          </p>
        </div>
      </section>
