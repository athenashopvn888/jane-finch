...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("JFC01_age_verified");
    if (verified !== "true") {
      setShow(true);
    }
  }, []);
  ...
  const handleVerify = () => {
    localStorage.setItem("JFC01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              <img
                ...
                alt="Jane Finch Cannabis"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              Jane Finch Cannabis requires all visitors to be of legal age.
