          ...
          <div className={styles.storeGrid}>
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>{INTERSECTION}</span>
              </p>
            </div>
            <div className={styles.storeCard}>
              <span className={styles.storeIcon}>🕒</span>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                <a href={`tel:${PHONE_INTL}`} className={styles.storeLink}>{PHONE_DISPLAY}</a>
                <br />
                <a href={SITE_ORIGIN} className={styles.storeLink}>janefinchcannabis.ca</a>
              </p>
            </div>
            <div className={styles.storeCard}>
              <span className={styles.storeIcon}>🔥</span>
