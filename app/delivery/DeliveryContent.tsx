  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=JFC01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Jane Finch Cannabis is launching delivery across North York.
        ...
        <div className={styles.infoGrid}>
          <div className={styles.infoCard}>
            ...
            <p className={styles.infoDesc}>Order before 6 PM, delivered same day across North York.</p>
          </div>
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}>🌉</span>
            <h3 className={styles.infoTitle}>North York & Gatineau</h3>
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>2728 Jane St, North York</strong> —
            we are <strong>Open 24 Hours</strong>. Call <strong>(548) 323-2728</strong>.
          </p>
        </div>
      </div>
      <Footer />
