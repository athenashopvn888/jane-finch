...
export const metadata: Metadata = {
  ...
  description:
    "Visit Jane Finch Cannabis at 2728 Jane St, North York, ON M3L 2G6. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "2728 Jane St, North York. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
      ...
      <section className={styles.infoSection}>
        <div className={styles.container}>
          ...
          <div className={styles.mapSection}>
            <iframe
              src="https://maps.google.com/maps?q=2728%20Jane%20St,+North%20York,+ON+M3L%202G6&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Jane Finch Cannabis — 2728 Jane St, North York"
            ></iframe>
          </div>
        </div>
      </section>
