...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "MAGIC & OTHERS") {
    return {
      ...
      metaDescription: `Shop ${name} magic mushrooms and psilocybin products in North York at Jane Finch Cannabis. High quality and consistent. Walk-ins welcome. Open 24 Hours.`,
