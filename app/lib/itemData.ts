...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "EDIBLES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis edibles in North York at Jane Finch Cannabis. Consistent, discreet, and long-lasting effects. Walk-in available 24/7.`,
  ...
  if (cat.includes("VAPE")) {
    return {
      ...
      metaDescription: `Shop ${name} vape pens and cartridges in North York at Jane Finch Cannabis. Fast-acting and potent. Walk-in available 24/7.`,
  ...
  if (cat === "CONCENTRATES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis concentrate in North York at Jane Finch Cannabis. Highly potent and pure extracts. Walk-in available 24/7.`,
  ...
  if (cat === "PREROLLS") {
    return {
      ...
      metaDescription: `Get ${name} pre-rolled joints in North York at Jane Finch Cannabis. Premium flower, perfectly rolled. Walk-in available 24/7.`,
  ...
  if (cat === "MAGIC & OTHERS") {
    return {
      ...
      metaDescription: `Shop ${name} magic mushrooms and psilocybin products in North York at Jane Finch Cannabis. High quality and consistent. Walk-in available 24/7.`,
  ...
  return {
    ...
    metaDescription: `Buy ${name} in North York at Jane Finch Cannabis. Premium quality and best prices. Walk-in available 24/7.`,
