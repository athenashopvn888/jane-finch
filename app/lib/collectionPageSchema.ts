/**
 * Flower-tier schema contract (JFC01 rollout of the MJ01 CollectionPage + ItemList graph).
 *
 * SITE_ORIGIN must stay identical to nap.ts / homepage WebSite + CannabisStore @ids.
 * Keep this file free of nap/products runtime imports so Node contract tests can load it.
 *
 * Pattern:
 * 1. One `@graph` with CollectionPage + ItemList (FAQPage may stay a sibling script).
 ...
 * Schema is emitted on the canonical *-weed URL only.
 */
