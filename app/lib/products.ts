...
> = {
  EXOTIC: {
    ...
    color: "#f59e0b",
    icon: "\uD83D\uDD25",
    tagline: "Browse the Exotic Weed section and compare the listed flower details.",
  ...
  PREMIUM: {
    ...
    color: "#a78bfa",
    icon: "\uD83D\uDC8E",
    tagline: "Browse the Premium Weed section and compare the listed flower details.",
  ...
  "AAA+": {
    ...
    color: "#22d3ee",
    icon: "\u26A1",
    tagline: "Browse the AAA+ Weed section and compare the listed flower details.",
  ...
  AA: {
    ...
    color: "#34d399",
    icon: "\u2726",
    tagline: "Browse the AA Weed section and compare the listed flower details.",
  ...
  BUDGET: {
    ...
    color: "#94a3b8",
    icon: "\uD83D\uDCB0",
    tagline: "Browse the Budget Weed section and compare the listed flower details.",
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Nicotine Vapes North York | Jane Finch Cannabis",
    seoIntro: "Explore the Jane Finch Cannabis Nicotine Vape category in North York, kept separate from THC Vape products. Nicotine products are for adults 19+.",
    seoDescription: "Jane Finch Cannabis keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    faqs: [
      { q: "Are Nicotine Vape and THC Vape the same category?", a: "No. Jane Finch Cannabis keeps Nicotine Vape separate from THC Vape." },
      { q: "Who are nicotine products for?", a: "Nicotine products are for adults 19+. Nicotine is addictive." },
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "THC Vapes North York | Jane Finch Cannabis",
    seoIntro: "Explore the Jane Finch Cannabis THC Vape category in North York, kept separate from Nicotine Vape products.",
    seoDescription: "Jane Finch Cannabis keeps THC Vape products separate from Nicotine Vape products so shoppers can clearly distinguish the two categories.",
    faqs: [
