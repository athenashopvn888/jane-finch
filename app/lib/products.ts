...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles in North York | Jane Finch Cannabis",
    seoIntro: "Browse edibles category information at Jane Finch Cannabis in North York.",
    seoDescription: "Review edible-related menu categories at Jane Finch Cannabis in North York and confirm current menu details before visiting. This page is intended for general category browsing and does not promise current product availability.",
    faqs: [
      { q: "What edible information can shoppers review?", a: "Customers can review edible-related category information and confirm current menu details before visiting Jane Finch Cannabis." },
      ...
      { q: "How does this page help North York shoppers?", a: "It helps shoppers find the Jane Finch Cannabis edibles category and review store/menu information in one place." },
    ],
  },
  "VAPE PENS": {
    banner: "/banners/01_Vape_Pens.webp",
    name: "THC Vape", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Vape Pens in North York | Jane Finch Cannabis",
    seoIntro: "Browse vape category information at Jane Finch Cannabis in North York.",
    seoDescription: "Review vape-related menu categories at Jane Finch Cannabis in North York and confirm current menu details before visiting. This page is intended for general category browsing and does not promise current product availability.",
    faqs: [
      { q: "What vape information can shoppers review?", a: "Customers can review vape-related category information and confirm current menu details before visiting Jane Finch Cannabis." },
      { q: "Does this page guarantee current vape availability?", a: "No. This page is for general category browsing; customers should confirm current menu details before visiting." },
    ],
  },
  "VAPE DISPOSABLE": {
