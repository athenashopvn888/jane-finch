...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles North York — Gummies, Chocolates & Drinks",
    seoIntro: "Browse the full cannabis edibles menu at Jane Finch Cannabis on North York St, North York. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in North York? Jane Finch Cannabis stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 2728 Jane St — we are Open 24 Hours.",
    faqs: [
      ...
      { q: "Can I buy edibles at Jane Finch Cannabis?", a: "Yes! Visit us at 2728 Jane St, North York. We're open 24 hours a day, 7 days a week with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    banner: "/banners/01_Vape_Pens.webp",
    name: "THC Vape", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Vape Pens North York — THC & Nicotine Cartridges",
    seoIntro: "Shop THC and nicotine vape pens at Jane Finch Cannabis, North York. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Jane Finch Cannabis carries a curated selection of vape pens and cartridges in North York. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 2728 Jane St for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes North York — THC Disposable Pens",
    seoIntro: "THC disposable vapes available at Jane Finch Cannabis, North York. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Jane Finch Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 2728 Jane St, North York.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Cannabis Concentrates North York — Shatter, Wax, Hash & Live Resin",
    seoIntro: "Premium cannabis concentrates at Jane Finch Cannabis, North York. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Jane Finch Cannabis offers a premium selection of cannabis concentrates in North York. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 2728 Jane St.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls North York — Ready-to-Smoke Cannabis Joints",
    seoIntro: "Pre-rolled cannabis joints at Jane Finch Cannabis, North York. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Jane Finch Cannabis in North York. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 2728 Jane St — we are Open 24 Hours.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Jane Finch Cannabis, North York. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Jane Finch Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 2728 Jane St, North York.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes North York — Discount Tobacco at Jane Finch Cannabis",
    seoIntro: "Discount native cigarettes at Jane Finch Cannabis, North York. Premium and value brands at the best prices on North York St.",
    seoDescription: "Jane Finch Cannabis is your go-to source for affordable native cigarettes in North York. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 2728 Jane St in the heart of Jane St & Sheppard Ave W, we're Open 24 Hours.",
    faqs: [
      { q: "Do you sell cigarettes at Jane Finch Cannabis?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the Jane St & Sheppard Ave W area of North York." },
    ],
  },
  "MAGIC & OTHERS": {
    banner: "/banners/09_Magic_Stuff.webp",
    name: "Magic & Others", slug: "magic", color: "#ec4899", icon: "🍄",
    seoTitle: "Magic Mushrooms & More — North York",
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Jane Finch Cannabis, North York.",
    seoDescription: "Jane Finch Cannabis carries a curated selection of magic mushrooms and specialty products in North York. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 2728 Jane St for our full selection.",
    faqs: [
