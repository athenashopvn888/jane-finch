"""
Jane Finch Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the jane-finch folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Jane Finch Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://janefinchcannabis.ca")
    else:
